...
parser.add_argument('--data', type=str, required=False, default='WIFI', help='data')
parser.add_argument('--root_path', type=str, default='./data/ETT/', help='root path of the data file')
parser.add_argument('--data_path', type=str, default='WIFI.csv', help='data file')
parser.add_argument('--features', type=str, default='M', help='forecasting task, options:[M, S, MS]; M:multivariate predict multivariate, S:univariate predict univariate, MS:multivariate predict univariate')
parser.add_argument('--target', type=str, default='Status', help='target feature in S or MS task')
...
parser.add_argument('--seq_len', type=int, default=4000, help='input sequence length of Informer encoder')
...
parser.add_argument('--d_model', type=int, default=1000, help='dimension of model')
...
data_parser = {
    ...
    'WIFI':{'data':'WIFI.csv','T':'Status','M':[31,31,31],'S':[1,1,1],'MS':[31,31,1]}
}
